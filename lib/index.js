...
var ReactDatatable = function (_Component) {
  ...
  function ReactDatatable(props) {
    ...
    _this.extraPlusButton = props.extraPlusButton;
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'table-body asrt-table-body', style: _style2.default.table_body, id: this.props.id ? this.props.id + "-table-body" : "" },
          _react2.default.createElement(
            'table',
            ...
            _react2.default.createElement(
              ...
              this.props.loading === true ? _react2.default.createElement(
                ...
                return _react2.default.createElement(
                  'tr',
                  { key: record[_this8.config.key_column],
                    onMouseEnter: function onMouseEnter(e) {
                      return _this8.props.onRowHovered(true, e, record, rowIndex);
                    },
                    onMouseLeave: function onMouseLeave(e) {
                      return _this8.props.onRowHovered(false, e, record, rowIndex);
                    },
...
ReactDatatable.defaultProps = {
  ...
  onRowHovered: function onRowHovered() {}
};
